...
[Run the free SEO ROI calculator](/seo-roi-calculator) to turn those traffic and conversion assumptions into gross profit, year-one return and payback.
...
Connect the [SearchCrew MCP](/docs/mcp) and the sizing runs against live difficulty and volume data instead of a stale export.

```text
Using the SearchCrew MCP, research keywords for "[my topic]" and cluster
