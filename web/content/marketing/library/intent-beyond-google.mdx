...
![SearchCrew keyword research results with the intent column labelling each keyword informational, navigational, commercial or transactional](/library/keyword-research/intent-by-surface-searchcrew.png)
...
```text
Using the SearchCrew MCP, research keywords for "[my topic]" and label
