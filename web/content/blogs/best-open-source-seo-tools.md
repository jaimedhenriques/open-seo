...
| ---------------------------------------------------------- | ---------------------------------------------------------------------------------- | -------------------------------------------------- | ---------------------------------- |
| [SearchCrew](https://github.com/jaimedhenriques/searchcrew)  | Keyword research, rank tracking, backlinks, site audits, AI visibility             | DataForSEO usage with your own API key             | Cloudflare Workers; Docker path is being verified |
