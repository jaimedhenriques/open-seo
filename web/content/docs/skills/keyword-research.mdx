...
- Ask before saving keywords back to SearchCrew.
...
- Confirm before saving selected keywords to SearchCrew.

## Use it with SearchCrew MCP

Set up [SearchCrew MCP](/docs/mcp) so your agent can research live keyword metrics, inspect Google SERPs, check saved keywords, and save selected terms with your approval.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [Keyword Research skill](https://github.com/jaimedhenriques/searchcrew/tree/main/.agents/skills/keyword-research)
