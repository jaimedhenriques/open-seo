...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Google gives you two: autocomplete and People Also Ask. Your Search Console is the third and best; it's your site's actual tail. SearchCrew's hosted beta is designed to connect Search Console and expand those findings into keyword lists. Billing remains paused until the beta is production-ready.",
  },
];
