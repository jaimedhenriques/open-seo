...
const faqs = [
  {
    ...
    answer:
      "For SERP-overlap clustering at scale, paid tools exist, but for most sites, SearchCrew's research + an intent-grouping pass (the MCP prompt above) covers it. Judge tools by whether they cluster on SERP overlap; word-similarity clustering is a toy.",
  },
  {
