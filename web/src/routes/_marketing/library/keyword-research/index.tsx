...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "There is no universal set of three. SearchCrew uses four intent types: informational, navigational, commercial, and transactional. By shape, terms are often grouped as head, mid-tail, and long-tail.",
  },
  {
...
export const Route = createFileRoute("/_marketing/library/keyword-research/")({
  head: () =>
    buildPageSeo({
      ...
      description:
        "Eight demand-discovery strategies drawn from interviews with working SEOs, each with a workflow and an SearchCrew MCP prompt for its data-backed steps.",
      path: PATH,
    ...
    <article className="mx-auto max-w-5xl">
      <header className="max-w-3xl">
        ...
        <p className="mt-5 text-lg leading-8 text-[var(--color-brand-muted)]">
          ...
          SEOs, each with a workflow and an SearchCrew MCP prompt for its
          data-backed steps.
        </p>
      </header>
