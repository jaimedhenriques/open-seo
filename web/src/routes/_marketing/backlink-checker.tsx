...
export const Route = createFileRoute("/_marketing/backlink-checker")({
  head: () =>
    buildPageSeo({
      ...
      imageAlt: "SearchCrew free backlink checker",
    }),
...
const FAQS = [
  {
    ...
    answer:
      "Results come from DataForSEO's link index, the same data source that powers backlink research inside SearchCrew. The index is refreshed continuously, so counts can differ slightly from other tools that crawl the web on their own schedule.",
  },
  {
