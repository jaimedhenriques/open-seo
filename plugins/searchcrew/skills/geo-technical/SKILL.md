...
Vendored from [jaimedhenriques/geo-seo-claude](https://github.com/jaimedhenriques/geo-seo-claude), MIT.
The upstream licence is kept beside this file in `LICENSE`. Re-vendor rather than editing in place.
