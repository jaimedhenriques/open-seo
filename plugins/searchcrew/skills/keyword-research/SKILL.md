...
Turn seed topics into a prioritized keyword opportunity set using SearchCrew MCP data. The output should help the user decide what to target, what to save, and what to research next.
...
- Do not invent metrics. If SearchCrew does not return a value, write `unknown`.
