...
Connecting Google Analytics lets SearchCrew bind a GA4 property to a project. The
...
| ------------ | -------------------------------------------------------- |
| Deployed     | `https://your-searchcrew-domain.com/api/ga4/oauth/callback` |
...
Set these values and restart SearchCrew:
...
SearchCrew stores the OAuth tokens encrypted in Better Auth's account table. The
