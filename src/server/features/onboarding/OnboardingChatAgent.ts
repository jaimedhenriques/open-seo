...
function buildSystemPrompt(domain: string | null): string {
  return [
    ...
    "Only answer questions related to SEO, SearchCrew, SearchCrew setup, MCP/AI-agent SEO workflows, Google Search Console in SearchCrew, or self-hosting topics. If the user asks about anything else, politely say you're here to help them get up and running with SearchCrew and ask what they want to know about SearchCrew or SEO.",
