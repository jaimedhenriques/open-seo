...
const ProjectPProjectIdGeoCrawlersRoute =
  ProjectPProjectIdGeoCrawlersRouteImport.update({
    id: '/geo-crawlers',
    path: '/geo-crawlers',
    getParentRoute: () => ProjectPProjectIdRouteRoute,
  } as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_project/p/$projectId/geo-crawlers': {
      id: '/_project/p/$projectId/geo-crawlers'
      path: '/geo-crawlers'
      fullPath: '/p/$projectId/geo-crawlers'
