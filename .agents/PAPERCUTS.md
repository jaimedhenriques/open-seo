...
- [ ] `2026-09-05T14:04:00Z` — `codex` — The website's full `format:check` reports 13 unchanged baseline files outside the screenshot-branding change. Reconcile the website formatting baseline in a scoped cleanup; changed-file formatting passes independently.
