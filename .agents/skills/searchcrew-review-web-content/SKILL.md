---
name: searchcrew-review-web-content
description: Write and review content for the SearchCrew website (web/) — blog posts, guides, feature pages, FAQs. Distills the philosophy for on-brand, useful, accurate content. Use whenever adding or editing user-facing prose in web/content or web/src.
metadata:
  internal: true
---

# SearchCrew Web Content
...
7. **Playbook terminology.** Call each approach within any SearchCrew playbook a "strategy," never a "play." Use "workflow" for the steps readers execute; use "playbook" only for the complete collection.

## Questions to ask while reviewing

- If a reader trusted every claim and screenshot, then opened SearchCrew right now, where would reality not match?
