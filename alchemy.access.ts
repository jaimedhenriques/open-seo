...
// `searchcrew-<stage>` naming stays comment-synced (and is backstopped by the
...
const WORKER_PREFIX = "searchcrew";

// The one stage that adopts searchcrew.ai's live hosted resources (unsuffixed
// names, app.searchcrew.ai domain, Postgres). Deliberately not "prod" so a
